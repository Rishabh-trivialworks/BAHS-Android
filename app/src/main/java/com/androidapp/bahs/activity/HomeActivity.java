...
import com.androidapp.bahs.BAHSApp;
...
import com.androidapp.bahs.utils.googlelogin.GPlusSignInActivity;
...
public class HomeActivity extends BaseActivity implements FacebookLoginListener {
    ...
    private void doGPlusSignIn(Intent data) {
        ...
        if (user.getImgFile() != null)
         ...
         AlertUtils.getInstance().showToast(this, user.getComplete_name());
       // GPlusSignup(user);
    }
