 ...
 * Description: A great thing with using retrofit is that, you do not need to parse json by yourself. Retrofit android library will do it for you. You only need to create a model.
 */
public class LoginModel
{
    ...
    @Expose
    private String isVerifiedMobile;
    /**
     *
     * @return
     * The status
    ...
    /**
     *
     * @param isVerifiedMobile
     * The is_verified_mobile
     */
